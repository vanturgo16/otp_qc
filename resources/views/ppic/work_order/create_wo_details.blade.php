...
@section('konten')
    <div class="page-content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">Add Work Order Details</h4>
                        <div class="page-title-right">
                            <ol class="breadcrumb m-0">
                                <li class="breadcrumb-item"><a href="javascript: void(0);">PPIC</a></li>
                                <li class="breadcrumb-item active">Add Work Order Details</li>
                            </ol>
                        </div>
                    </div>
                </div>
            ...
            <div class="row pb-3">
                <div class="col-12">
                    <a href="{{ route('ppic.workOrder.woDetails', encrypt($work_order->wo_number)) }}" class="btn btn-primary waves-effect btn-label waves-light">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <form action="{{ route('ppic.workOrder.storeWODetail') }}" method="POST" id="">
                            @csrf
                            <div class="card-header">
                                <i class="mdi mdi-file-multiple-outline label-icon"></i> Add Work Order Details
                            </div>
                                ...
                                <div class="mt-4 mt-lg-0">
                                    <div class="row mb-4 field-wrapper required-field">
                                        <div class="row mb-4 field-wrapper required-field">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="text" class="form-control" name="wo_number" id="wo_number" value="{{ $work_order->wo_number }}" readonly required>
                                                <input type="hidden" class="form-control" name="id_work_orders" id="id_work_orders" value="{{ $work_order->id }}" required>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row mb-4 field-wrapper required-field">
                                        ...
                                        <div class="col-sm-9">
                                            <select class="form-control data-select2 unitSelect" name="id_master_units" id="masterUnitSelect"
                                ...
                                <div class="row justify-content-end">
                                    <div class="col-sm-9">
                                        <div>
                                            ...
                                            <input type="submit" class="btn btn-success w-md saveWorkOrder" value="Save"
                                                name="save">
                                        </div>
                                    </div>
                                </div>
