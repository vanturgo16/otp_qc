...
@section('konten')
    ...
    <div class="page-content">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                        <h4 class="mb-sm-0 font-size-18">LMTS (Laporan Material Testing & Stock)</h4>
                                ...
                                <div class="d-flex justify-content-start align-items-end w-100 gap-2">
                                    <div class="d-flex gap-2">
                                        ...
                                        <div class="align-self-end">
                                            ...
                                            <a href="{{ route('lmts.export.excel', request()->all()) }}"
                                                ...
                                                <div class="modal-body">
                                                    <div class="mb-3">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            id="filter_receipt_number" name="receipt_number"
                                                    ...
                                                    <div class="mb-3">
                                                        <label for="filter_type_product" class="form-label">Type
                                                            Product</label>
                                                        <select class="form-control" id="filter_type_product"
                                                            name="type_product">
                                                            <option value="">-- Pilih Type Product --</option>
                                                            <option value="TA"
                                                                {{ request('type_product') == 'TA' ? 'selected' : '' }}>TA
                                                            </option>
                                                            <option value="FG"
                                                                {{ request('type_product') == 'FG' ? 'selected' : '' }}>FG
                                                            </option>
                                                            <option value="RM"
                                                                {{ request('type_product') == 'RM' ? 'selected' : '' }}>RM
                                                            </option>
                                                        </select>
                                                    </div>
                                                    <div class="mb-3">
                                    ...
                                    <tbody>
                                        @forelse ($datas as $data)
                                            <tr>
                                                ...
                                                <td>{{ $data->date }}</td>
                                                <td>{{ number_format($data->total_glq, 2) }}</td>
                                                <td>{{ $data->unit }}</td>
                                                <td>
                                                    @switch($data->type_product)
                                                        @case('TA')
                                                            <span class="badge bg-info">{{ $data->type_product }}</span>
                                                        @break

                                                        @case('FG')
                                                            <span class="badge bg-success">{{ $data->type_product }}</span>
                                                        @break

                                                        @case('RM')
                                                            <span class="badge bg-warning">{{ $data->type_product }}</span>
                                                        @break

                                                        @default
                                                            <span class="badge bg-secondary">{{ $data->type_product }}</span>
                                                    @endswitch
                                                </td>
                                                <td>
                                                    @php
                                                ...
                                                <td>
                                                    ...
                                                    @if ($data->status != 0)
                                                        <a href="{{ route('lmts.print', $data->id) }}"
                                                    ...
                                                    @if ($data->status == 0)
                                                        ...
                                                        @if ($isRepair == 1)
                                                            ...
                                                            <button type="button" class="btn btn-warning btn-sm"
                                                                data-bs-toggle="modal"
                                                                data-bs-target="#modalRepair{{ $loop->iteration }}">
                                                                <i class="mdi mdi-wrench"></i> Repair
                                                            </button>
                                                        @endif
                                                        ...
                                                        @if ($isScrap == 0 && $isRepair == 0 && $isReturn == 0)
                                                            <span class="badge bg-secondary text-white">No Action
                                                                Available</span>
                                                        @endif
                                                        ...
                                                        @if (auth()->user()->role == 'Super Admin' ||
                                                            ...
                                                            <button type="button" class="btn btn-dark btn-sm"
                                                                ...
                                                                <i class="mdi mdi-delete-forever"></i> Unposted
                                                            </button>
                                                        @endif
                                                    @else
                                                ...
                                                <tr>
                                                    <td colspan="13" class="text-center">
                                                        <div class="py-4">
                                                            ...
                                                            <p class="text-muted mt-2">Tidak ada data LMTS yang ditemukan</p>
                                                        </div>
                                                    </td>
                                                </tr>
                                            @endforelse
        ...
        @foreach ($datas as $data)
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-warning py-2">
                                        ...
                                        <strong>Peringatan:</strong> Proses scrap akan mengurangi stock dan mengubah status
                                        LMTS.
                                    </div>
                                    ...
                                    <div class="row g-2 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="fw-bold text-danger">{{ number_format($data->qty, 2) }}</div>
                                        </div>
                                        @if ($data->id_master_products)
                                            @php
                                                $masterProduct = DB::table('master_product_fgs')
                                                    ->where('id', $data->id_master_products)
                                                    ->first();
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div>
                                                    <span
                                                        class="badge {{ $currentStock >= $data->qty ? 'bg-success' : 'bg-danger' }}">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <label for="scrap_date{{ $loop->iteration }}">Tanggal Scrap <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="scrap_date" id="scrap_date{{ $loop->iteration }}"
                                                class="form-control" value="{{ now()->format('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="lmts_notes{{ $loop->iteration }}">Catatan <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="lmts_notes" id="lmts_notes{{ $loop->iteration }}" class="form-control" rows="2"
            ...
            @if ($isRepair == 1)
                <!-- Modal Repair -->
                <div class="modal fade" id="modalRepair{{ $loop->iteration }}" tabindex="-1"
                    aria-labelledby="modalRepairLabel{{ $loop->iteration }}" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="{{ route('lmts.repair', $data->id) }}" method="POST">
                            @csrf
                            <div class="modal-content">
                                <div class="modal-header bg-warning">
                                    <h5 class="modal-title" id="modalRepairLabel{{ $loop->iteration }}">
                                        <i class="mdi mdi-wrench"></i> Repair Data LMTS
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="alert alert-warning py-2">
                                        ...
                                        <strong>Informasi:</strong> Proses repair akan mengembalikan barang ke inventory setelah
                                        diperbaiki.
                                    </div>
                                    ...
                                    <div class="row g-2 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            <small class="text-muted">Qty Repair</small>
                                            <div class="fw-bold text-warning">{{ number_format($data->qty, 2) }}</div>
                                        </div>
                                        <div class="col-md-6">
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <label for="repair_date{{ $loop->iteration }}">Tanggal Repair <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="repair_date" id="repair_date{{ $loop->iteration }}"
                                                class="form-control" value="{{ now()->format('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="repair_notes{{ $loop->iteration }}">Catatan Repair <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="repair_notes" id="repair_notes{{ $loop->iteration }}" class="form-control" rows="2"
                                                placeholder="Jenis perbaikan yang dilakukan..." required></textarea>
                                            <small class="text-muted">Contoh: Perbaikan surface coating, dimensional
                                                adjustment, dll.</small>
                                        </div>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-warning">
                                        <i class="mdi mdi-wrench"></i> Proses Repair
                                    </button>
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Batal</button>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="alert alert-info py-2">
                                        ...
                                        <strong>Informasi:</strong> Proses return akan mengembalikan barang ke supplier,
                                        mengurangi stock dan mengubah status LMTS.
                                    </div>

                                    <div class="alert alert-warning py-2">
                                        <i class="mdi mdi-truck-delivery"></i>
                                        <strong>Catatan:</strong> Barang yang di-return akan dikembalikan ke supplier dan stock
                                        akan berkurang dari inventory.
                                    </div>
                                    ...
                                    <div class="row g-2 mb-3">
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="fw-bold text-info">{{ number_format($data->qty, 2) }}</div>
                                        </div>
                                        @if ($data->id_master_products)
                                            @php
                                                $masterProduct = DB::table('master_product_fgs')
                                    ...
                                    <div class="row g-2">
                                        <div class="col-md-6">
                                            <label for="return_date{{ $loop->iteration }}">Tanggal Return <span
                                                    class="text-danger">*</span></label>
                                            <input type="date" name="return_date" id="return_date{{ $loop->iteration }}"
                                                class="form-control" value="{{ now()->format('Y-m-d') }}" required>
                                        </div>
                                        <div class="col-md-6">
                                            <label for="return_reason{{ $loop->iteration }}">Alasan Return ke Supplier <span
                                                    class="text-danger">*</span></label>
                                            <textarea name="return_reason" id="return_reason{{ $loop->iteration }}" class="form-control" rows="2"
                                                placeholder="Masukkan alasan mengapa barang dikembalikan ke supplier..." required></textarea>
                                            <small class="text-muted">Contoh: Kualitas tidak sesuai, defect, expired,
                                                dll.</small>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-header bg-dark text-white">
                                    <h5 class="modal-title" id="modalUnpostedLabel{{ $loop->iteration }}">
                                        <i class="mdi mdi-delete-forever"></i> Unposted Data LMTS
                                    </h5>
                                    <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
                                </div>
                                <div class="modal-body">
                                    <div class="alert alert-danger">
                                        ...
                                        <strong>PERINGATAN KERAS!</strong> Anda akan menghapus data LMTS ini secara permanen
                                        dari database.
                                    </div>
                                    ...
                                    <div class="form-check mt-3">
                                        <input class="form-check-input" type="checkbox"
                                            id="confirmDelete{{ $loop->iteration }}" required>
                                        <label class="form-check-label text-danger"
                                            for="confirmDelete{{ $loop->iteration }}">
                                            <strong>Saya memahami bahwa data ini akan dihapus permanen</strong>
                                        </label>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="submit" class="btn btn-danger" id="btnDelete{{ $loop->iteration }}"
                                        disabled>
