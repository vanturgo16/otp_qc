...
@section('konten')
    ...
    <style>
        .section-title {
            background: #edeef2;
            /* mirip bg-muted abu2 di screenshot */
            border-radius: .25rem;
            padding: .9rem 1rem;
            font-weight: 600;
        }
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-3">
                        <div>
                            <a href="{{ route('historystock.fg', array_filter(['searchDate' => $searchDate ?? null, 'month' => $month ?? null])) }}"
                                ...
                                <i class="mdi mdi-arrow-left label-icon"></i> Back To List History Stock Sample
                            </a>
                        </div>
                        <ol class="breadcrumb m-0">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Master Data</a></li>
                            <li class="breadcrumb-item"><a href="{{ route('historystock.fg') }}">List History Stock Sample
                                </a></li>
